...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg2.hasClass("inview")) {
            bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, 1000, -0.25)});
        }
        if ($bg3.hasClass("inview")) {
            bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 3500, 0.18)});
        }
        if ($bg4.hasClass("inview")) {
            bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, 1700, -0.16)});
        }
        if ($bg5.hasClass("inview")) {
            bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 100, 0.25)});
        }
